...
def create_thing_payload(thing_name, indent):
    ...
    payload["description"] = "This Thing was created by datasim.py"

    location = dict()
    location["name"] = thing_name
    location["description"] = "This Location was created by datasim.py"
...
def create_data_stream_payload(data_stream_name, indent):
    ...
    payload["description"] = "This Datastream was created by datasim.py"
    ...
    observed_property["description"] = "This ObservedProperty was created by datasim.py"
    observed_property["definition"] = "unknown"

    payload["ObservedProperty"] = observed_property

    sensor = dict()
    sensor["name"] = "Pseudo Sensor created by datasim.py"
